...
public abstract class BaseShapeRenderer
{
    ...
    public abstract void drawGradientImage(double x, double y, double sX, double sY, double u1, double v1, double u2, double v2, double a1, double a2, double a3, double a4, String image, boolean scaled);
}
